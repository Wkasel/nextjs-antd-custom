import { Breadcrumb, Row, Col, Layout, Card, Carousel } from "antd";
import {
  PhoneFilled,
  HomeOutlined,
  UserOutlined,
          ...
          <Row justify="space-around" type="flex">
            ...
            <Col span={12} md={12} xs={0}>
              <span className="ml-30 float-right">
                <PhoneFilled /> Call us 09-999-9999
              </span>
            </Col>
          </Row>
        </Col>
        ...
        <Content>
          <div>
            <Carousel autoplay>
              <div>
                <h3>
                  <img src="/images/big-images.jpg" />
                </h3>
              </div>
              <div>
                <h3>
                  <img src="/images/big-images-2.jpg" />
                </h3>
              </div>
              <div>
                <h3>
                  <img src="/images/big-images-3.jpg" />
                </h3>
              </div>
            </Carousel>
          </div>
